...
class myConfig(object):
    ...
    g_model_path = "../models/old_entity_attn_only_supervised/gen_after_rlandsuper_epoch_19.pth"#"../models/entity_attn_only_supervised/g_after_supervised.pth" 
    d_model_path = "" #../models/third_train_fixed/d_after_supervised.pth" 
    
    # To store the generated sentences
    generated_path = 'entity_generated_sent_beam.txt'
