...
class myConfig(object):
    ...
    g_model_path = "one_input/g_after_supervised.pth"#"../models/third_train_fixed/g_after_supervised.pth" 
    d_model_path = "one_input/d_after_supervised.pth" #../models/third_train_fixed/d_after_supervised.pth" 
